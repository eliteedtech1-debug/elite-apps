...
|---------------|-----------|-----------|-----------|
| **Elite Scholar** | `.env` or `.env.elitescholar` | `/assets/img/mini-logo.png` | 18KB |
...
**Result**:
- ✅ Elite Scholar build → Uses `mini-logo.png`
...
**Expected Output for Elite Scholar**:
```
Logo: /assets/img/mini-logo.png
App Name: ELITE SCHOLAR
...
### Elite Scholar Deployment

```bash
# 1. Ensure Elite Scholar .env is active
cp .env.elitescholar .env
...
| **Elite Scholar** | ✅ Supported | Uses mini-logo.png |
