...
A comprehensive lesson planning and note-taking system for the Elite Scholar School Management System, enabling teachers to create, submit, and manage lesson plans while allowing administrators to review and track teaching progress.
...
- Node.js 16+ 
- MySQL 8.0+
- Existing Elite Scholar SMS installation
...
**Built for Elite Scholar School Management System**
