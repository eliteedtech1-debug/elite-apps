...
This document explains how to configure Paystack split payments for the Elite Core application.

## Overview

The Elite Core application uses Paystack's split payment functionality to distribute payments between the platform and vendors/schools. This allows for automated commission calculations and revenue distribution.
