...
VALUES 
(UUID(), 3876, 'SCH/23', 'BRCH/29', 'Welcome to Elite Core', 'You can now view all your notifications here. Stay updated with assignments, exams, and announcements.', 'notification', 'announcement', 0, '{"audience": "student"}');
```
