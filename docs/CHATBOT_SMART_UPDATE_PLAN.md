# Smart Chatbot Update Plan - Elite Core
...
const SmartChatbot: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setMessages([{
      id: '1',
      text: 'Hello! I\'m your Elite Core assistant. Ask me how to do something, like "How to add a subject?" or type "help" to see what I can do.',
      isBot: true,
      timestamp: new Date()
    }]);
  }, []);
    ...
    <Card 
      title={
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <span>Elite Core Assistant</span>
        </div>
      }
