...
git init
git add .
git commit -m "Initial commit: Elite Core Android v1.0.0"
git branch -M main
...
2. Fill in:
   - **Tag version:** `v1.0.0`
   - **Release title:** `Elite Core v1.0.0`
   - **Description:** `Initial release with Elite Core logo`
3. Upload `EliteCore-v1.0.0.apk` from Desktop
...
cp app/build/outputs/apk/release/app-release.apk ~/Desktop/EliteCore-v1.0.1.apk
```
...
```json
{
  "version": "1.0.1",
  "versionCode": 2,
  "apkUrl": "https://github.com/eliteedtech1-debug/elitescholar.app/releases/download/v1.0.1/EliteCore.apk",
